                    ...
                    <div className="container">
                        <div className="row">
                            <div className={ClassNames('col-md-8', 'offset-md-2')}>
                                ...
                                <p>Our experience is available on any listening platform! <strong>Available Now!</strong></p>
                                <div className="badges">
                                    <a className="badge-link" href="https://play.google.com/store/music/album/DJ_Donovan_Mr_Office?id=B7arpckfgri2kz6a47co5syneiu" target="_blank"><img src="/public/media/google-play-badge.svg" alt="Download Mr. Office by DJ Donovan on Google Play" /></a>
                                    <a className="badge-link" href="https://itunes.apple.com/us/album/mr-office/id1265544525" target="_blank"><img src="/public/media/Get_it_on_iTunes_Badge_US_1114.svg" alt="Download Mr. Office by DJ Donovan on iTunes" /></a>
                                    <a className="badge-link" href="https://open.spotify.com/album/3Eo1PXNTehA5GqcTCl9wW6" target="_blank"><img src="/public/media/btn-spotify.svg" alt="Stream Mr. Office by DJ Donovan on Spotify" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container"> 
                        ...
                        <ul className={ClassNames('list-inline', 'list-social')}>
                            ...
                            <li className={ClassNames('list-inline-item', 'social-facebook')}>
                                <a href="https://www.facebook.com/djdonovanmusic/" target="_blank"><i className={ClassNames('fa', 'fa-facebook')}></i></a>
                            </li>
                        </ul>
                    </div>
                </section>
